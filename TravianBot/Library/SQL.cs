...
namespace Library
{
    public class SQL
    {
        ...
        /// <returns></returns>
        /// 
        public static bool InsertVillages(ServerData sd, Village v)
        {
        ...
        public static bool InsertProduction(ServerData sd, Village v, int village)
        {
...
// ReSharper disable UnusedMethodReturnValue
        private static bool InsertResourceForVillage(ServerData sd, Resource resource)
