...
namespace jeza.ioFTPD.Framework.Json {
	public class JsonObject : DynamicObject, INotifyPropertyChanged   {

		protected Dictionary<string, object> _thisDict;

	    public Dictionary<string, object> ThisDict
	    {
	        get { return _thisDict; }
	    }

	    public JsonObject(){
			_thisDict = new Dictionary<string, object>();
		}

		public bool IsEmpty { get { return _thisDict.Count == 0; } }
		public IEnumerable<string> Keys { get { return _thisDict.Keys; } }
		public IEnumerable<object> Values { get { return _thisDict.Values; } }
