...
namespace ioFTPD.Tests
{
    ...
    public class ZipScriptTests
    {
        ...
        public void RaceRar()
        {
            ...
            race.Parse();
            Assert.AreEqual(".rar", race.FileExtension, "FileExtension");
            Assert.AreEqual("infected.part1.rar", race.FileName, "FileName");
            Assert.AreEqual(5000, race.FileSize, "FileSize");
