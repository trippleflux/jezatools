...
/*  DEFAULT                */ 
/***************************/
#define iojZS_version				"1.16"
#define iojZS_no_check_dirs			"/PRIVATE/ /REQUEST/"
#define iojZS_no_mp3_symlink_dirs		"/_PRE/"
#define iojZS_no_message_dirs			"/_PRE/"
...
#define iojZS_allow_genre			"dance,trance,pop,disco,hip-hop,r&b,house,freestyle,instrumental,eurodance,club,dance hall,country,rock,heavy metal,oldies,metal,top 40,top_40,rap,punk,folk"
#define iojZS_skip_genre			"indie,lo-fi,noise,gothic,ska,psychiadelic"
...
#define iojZS_total_display_groups		10
...
/*  SYMLiNKS               */ 
/***************************/
#define iojZS_mp3_genre_dir			"j:\\_SORTED\\_MP3.genre"
#define iojZS_mp3_year_dir			"j:\\_SORTED\\_MP3.year"
#define iojZS_mp3_group_dir			"j:\\_SORTED\\_MP3.team"
#define iojZS_mp3_group_artist			"j:\\:SORTED\\_MP3.artist"
/***************************/
/*  .ioFTPD.message        */ 
/***************************/
...
#define iojZS_msg_mp3_info			"  MP3 iNFO..:                                                           \n" \
						...
						"                                                                        \n" \
						"                                                                        \n"
#define iojZS_msg_head_users			"                            U S E R S T O P                             \n" \
						" ---------------------------------------------------------------------- \n"
...
#define iojZS_write_affils_stats		true		//will write USER/GROUP TOP to .ioFTPD.message
#define iojZS_check_files_when_race		true		//will check if all files exists that are loged to racefile. if true a litle slower files check
#define iojZS_create_bad_files			true		//true will create xxx.bad file [false will delete failed file]
#define iojZS_log_ioftpd			true		//write to ../logs/ioFTPD.log
#define iojZS_log_iojzs				true		//write to iojZS_logfile
#define iojZS_create_stats_files		false		//will create iojZS_users_stats_file file for each user
#define iojZS_check_ok_genre			true		//allowed only iojZS_allow_genre
#define iojZS_check_bad_genre			true		//not allowed if iojZS_skip_genre
#define iojZS_delete_bad_genre			false		//delete if any of iojZS_skip_genre or not iojZS_allow_genre
...
#define iojZS_symlink_mp3_sort			true		//sort mp3 rls
#define iojZS_use_ntfs_junction_point		false		//use NFTS to symlink sorted mp3s
#define iojZS_symlink_mp3_genre			true		//sort by genre		iojZS_symlink_mp3_sort must be enabled
#define iojZS_symlink_mp3_year			true		//sort by year		iojZS_symlink_mp3_sort must be enabled
#define iojZS_symlink_mp3_group			true		//sort by group		iojZS_symlink_mp3_sort must be enabled
...
#define iojZS_anounce_bad_file			true		//iojZS_irc_bad_file
#define iojZS_anounce_nfo			true		//iojZS_irc_nfo
...
#define iojZS_get_racers			true		// [%o ] in iojZS_irc_race -->> iojZS_irc_users_race like Jeza is racing [kekec(iND) rozle(TRiAL) ]
#define iojZS_anounce_race			true		//iojZS_irc_race
#define iojZS_anounce_newleader			true		//iojZS_irc_newleader
#define iojZS_anounce_halfway			true		//iojZS_irc_halfway
#define iojZS_anounce_complete			true		//iojZS_irc_complete,iojZS_irc_no_race_complete
#define iojZS_anounce_user_head			true		//iojZS_irc_user_head
#define iojZS_anounce_user_stats		true		//iojZS_irc_user_stats
#define iojZS_anounce_group_head		true		//iojZS_irc_group_head
...
#define iojZS_anounce_rar_norace_complete	true		//iojZS_irc_no_race_complete
...
#define iojZS_irc_mp3_update			"%C03%BInfo!%B%C %B%R%B (%B%t%BF of %C03%B%U%X%U%B%C from %B%Y%B)"
#define iojZS_irc_mp3_bad_genre			"%C04%BStop!%B%C %B%R%B (%C03%B%U%X%U%B%C Not Allowed Genre)"
...
#define iojZS_irc_complete			"%BDone!%B %B%R%B (%B%e%B at %B%J%BkBps in %M)"
#define iojZS_irc_no_race_complete		"%BDone!%B %B%R%B (%B%m%B at %B%s%BkBps in %M) by %B%u%B"
...
#define iojZS_irc_user_stats			"%p. %B%-14u%B (%9m %3P%% %3fF %5skBps)"
#define iojZS_irc_group_head			"GroupTop:"
#define iojZS_irc_group_stats			"%p. %B%-14g%B (%9b %3Q%% %3cF %5qkBps)"
