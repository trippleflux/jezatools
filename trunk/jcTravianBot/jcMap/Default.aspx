...
<body>
    ...
    <div>
		...
		<asp:LinkButton ID="linkButtonRefreshMap" runat="server" 
			Style="z-index: 101; left: 20px; position: absolute; top: 20px" OnClick="linkButtonRefreshMap_Click" Width="90px">Refresh Map</asp:LinkButton>
        <asp:DropDownList ID="dropDownListServers" runat="server" 
            Style="z-index: 102; left: 20px; position: absolute; top: 50px" Width="90px">
            <asp:ListItem Selected="True">si_s3</asp:ListItem>
        </asp:DropDownList>
		<asp:LinkButton ID="linkButtonImportData" runat="server" 
			Style="z-index: 100; left: 20px; position: absolute; top: 80px" OnClick="linkButtonImportData_Click" Enabled="False" Width="90px">Import Data</asp:LinkButton>
        ...
        <asp:TextBox ID="TextBoxAlly" runat="server" 
            Style="z-index: 110; left: 360px; position: absolute; top: 20px" Width="400px">HG,BZP</asp:TextBox>
        ...
        <asp:TextBox ID="TextBoxNap" runat="server" 
            Style="z-index: 112; left: 360px; position: absolute; top: 50px" Width="400px">TSF,RE.NO.</asp:TextBox>
        ...
        <asp:Label ID="LabelAliance" runat="server" 
            Style="z-index: 122; left: 300px; position: absolute; top: 110px" 
            Text="Aliance" Width="50px" BackColor="Red"></asp:Label>
        <asp:TextBox ID="textBoxAliance" runat="server" 
            Style="z-index: 123; left: 360px; position: absolute; top: 110px" Width="400px">*</asp:TextBox>
        &nbsp; &nbsp;&nbsp;
		...
		<asp:Table ID="tableMap" runat="server" 
			Style="z-index: 119; left: 20px; position: absolute; top: 170px" OnDataBinding="linkButtonRefreshMap_Click">
		</asp:Table>
