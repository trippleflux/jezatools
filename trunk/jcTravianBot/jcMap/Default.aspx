...
<body>
    ...
    <div>
		...
		<asp:TextBox ID="textBoxDistance" runat="server" 
			Style="z-index: 106; left: 120px; position: absolute; top: 80px" Width="40px" Enabled="False">20</asp:TextBox>
		<asp:LinkButton ID="linkButtonImportData" runat="server" 
			Style="z-index: 107; left: 240px; position: absolute; top: 20px" OnClick="linkButtonImportData_Click">Import Data</asp:LinkButton>
		<asp:LinkButton ID="linkButtonRefreshMap" runat="server" 
			Style="z-index: 108; left: 240px; position: absolute; top: 50px" OnClick="linkButtonRefreshMap_Click">Refresh Map</asp:LinkButton>
    
		<asp:Table ID="tableMap" runat="server" 
			Style="z-index: 109; left: 20px; position: absolute; top: 110px" OnDataBinding="linkButtonRefreshMap_Click">
		</asp:Table>
