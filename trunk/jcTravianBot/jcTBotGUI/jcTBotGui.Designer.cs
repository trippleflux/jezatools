namespace jcTBotGUI
{
	partial class jcTBotGui
	{
		...
		private void InitializeComponent()
		{
			...
			this.getResourcesForVillageBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.getResourcesForVillageTableAdapter = new jcTBotGUI.jcTBotDataSetTableAdapters.GetResourcesForVillageTableAdapter();
			...
			((System.ComponentModel.ISupportInitialize)(this.getResourcesForVillageBindingSource)).BeginInit();
			this.SuspendLayout();
			// 
			// tabControl
			// 
			...
			this.tabControl.Size = new System.Drawing.Size(1018, 828);
			...
			this.Login.Size = new System.Drawing.Size(1010, 802);
			...
			this.Villages.Size = new System.Drawing.Size(1010, 802);
			...
			this.dataGridViewBuildings.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.dataGridViewBuildings.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.AllCells;
			...
			this.dataGridViewBuildings.Location = new System.Drawing.Point(500, 345);
			...
			this.dataGridViewBuildings.Size = new System.Drawing.Size(501, 430);
			...
			this.dataGridViewResources.Location = new System.Drawing.Point(8, 345);
			...
			this.dataGridViewResources.Size = new System.Drawing.Size(486, 430);
			...
			this.dataGridViewVillages.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			...
			this.dataGridViewVillages.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dataGridViewVillages.Size = new System.Drawing.Size(993, 331);
			...
			this.dataGridViewVillages.Click += new System.EventHandler(this.dataGridViewVillages_Click);
			// 
			...
			this.villageNameDataGridViewTextBoxColumn1.Width = 91;
			// 
			...
			this.warehouseDataGridViewTextBoxColumn.Width = 87;
			// 
			...
			this.granaryDataGridViewTextBoxColumn.Width = 69;
			// 
			...
			this.woodDataGridViewTextBoxColumn.Width = 61;
			// 
			...
			this.clayDataGridViewTextBoxColumn.Width = 52;
			// 
			...
			this.ironDataGridViewTextBoxColumn.Width = 50;
			// 
			...
			this.cropDataGridViewTextBoxColumn.Width = 54;
			// 
			...
			this.clayPerHourDataGridViewTextBoxColumn.Width = 91;
			// 
			...
			this.ironPerHourDataGridViewTextBoxColumn.Width = 89;
			// 
			...
			this.cropPerHourDataGridViewTextBoxColumn.Width = 93;
			// 
			...
			this.Attacks.Size = new System.Drawing.Size(1010, 802);
			...
			// Tasks
			// 
			this.Tasks.Controls.Add(this.labelTasksPriority);
			this.Tasks.Controls.Add(this.comboBoxTasksPriority);
			...
			this.Tasks.Size = new System.Drawing.Size(1010, 802);
			...
			// buttonAddNewTask
			// 
			this.buttonAddNewTask.Location = new System.Drawing.Point(643, 290);
			...
			this.dataGridViewTaskList.Size = new System.Drawing.Size(993, 260);
			...
			this.Map.Name = "Map";
			this.Map.Size = new System.Drawing.Size(1010, 802);
			this.Map.TabIndex = 4;
			this.Map.Text = "Map";
			...
			this.Reports.Size = new System.Drawing.Size(1010, 802);
			...
			this.Messages.Size = new System.Drawing.Size(1010, 802);
			...
			this.Status.Size = new System.Drawing.Size(1010, 802);
			...
			this.tabPageSendResources.Size = new System.Drawing.Size(1010, 802);
			...
			// 
			// getResourcesForVillageBindingSource
			// 
			this.getResourcesForVillageBindingSource.DataMember = "GetResourcesForVillage";
			this.getResourcesForVillageBindingSource.DataSource = this.jcTBotDataSet;
			// 
			// getResourcesForVillageTableAdapter
			// 
			this.getResourcesForVillageTableAdapter.ClearBeforeFill = true;
			// 
			// labelTasksPriority
			// 
			this.labelTasksPriority.AutoSize = true;
			this.labelTasksPriority.Location = new System.Drawing.Point(513, 276);
			this.labelTasksPriority.Name = "labelTasksPriority";
			this.labelTasksPriority.Size = new System.Drawing.Size(64, 13);
			this.labelTasksPriority.TabIndex = 13;
			this.labelTasksPriority.Text = "Build Priority";
			// 
			// comboBoxTasksPriority
			// 
			this.comboBoxTasksPriority.AllowDrop = true;
			this.comboBoxTasksPriority.FormattingEnabled = true;
			this.comboBoxTasksPriority.Location = new System.Drawing.Point(516, 292);
			this.comboBoxTasksPriority.Name = "comboBoxTasksPriority";
			this.comboBoxTasksPriority.Size = new System.Drawing.Size(121, 21);
			this.comboBoxTasksPriority.TabIndex = 12;
			this.comboBoxTasksPriority.Text = "10";
			// 
			// jcTBotGui
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.getResourcesForVillageBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource getResourcesForVillageBindingSource;
        private jcTBotGUI.jcTBotDataSetTableAdapters.GetResourcesForVillageTableAdapter getResourcesForVillageTableAdapter;
