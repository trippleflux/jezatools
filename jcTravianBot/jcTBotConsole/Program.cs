...
namespace jcTBotConsole
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            string pageSource = Browser.GetPageSource(loginPage, cookies);
			...
			String postData =
				String.Format("w=1152%3A864&login={0}&{1}={2}&{3}={4}&{5}={6}&s1.x=48&s1.y=8",
							  ...
							  lf.HiddenName,
							  lf.HiddenValue);
			string loginResponse = Browser.PostData(resourcesPage, postData, cookies);
			//Console.WriteLine(resourcesResponse);
			string villageResponse = Browser.GetPageSource(villagePage, cookies);
			...
			string sendUnitsResponse = Browser.GetPageSource(sendUnitsUrl, cookies);
			...
			postData = String.Format(CultureInfo.InvariantCulture, "b=1&&t1=1&t2=&t3=&t4=&t5=&t6=&t7=&t8=&t9=&t10=&t11={0}", buttonCords);
			...
			const string parTroops = "&t1=1&t2=0&t3=0&t4=0&t5=0&t6=0&t7=0&t8=0&t9=0&t10=0&t11=0";
