	...
	public class Build
	{
		...
		private void BuildLand()
		{
			...
			Console.WriteLine("{0} Level Is [ {1}], Wanted Level Is {2}",
				jcTBL.ResourceName, jcTBL.GetLevel2String(landLevels), jcTBL.WantedLevel);
			//do
			//{
				...
				Console.WriteLine(jcTBL.GetLevel2String(resources.NeededResources[landIDs[buildIndex]]));
				Thread.Sleep(15000);
